...
app.use(cors({
  origin: process.env.NODE_ENV === 'production' 
    ? ['https://classe-veneta-admin.vercel.app', 'https://cv-merch-frontend.vercel.app', 'https://admin-panel-cluuxuxpb-classe-venetas-projects.vercel.app'] // I tuoi domini production
